...
import com.codiansoft.foodtruck.decorators.DirectionsJSONParser;
...
public class DirectionMap extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        longs = Double.valueOf(getIntent().getStringExtra("long"));
    ...
    public void adddirection() {
        ...
        LatLng dest = new LatLng(lat, longs);
        ...
        destMarker.position(dest).title(String.valueOf(distancekm() + " km"));
        ...
        mMap.addMarker(destMarker).showInfoWindow();
        ...
        if (markerPoints.size() >= 2) {
            ...
            String url = getDirectionsUrl(origin, dests);
    ...
    public int distancekm() {
        ...
        locationA.setLongitude(longs);
        Location locationB = new Location("point B");
        locationB.setLatitude(currentLatlong.latitude);
        locationB.setLongitude(currentLatlong.longitude);
...
// Drawing polyline in the Google Map for the i-th route
    ...
    public void onConnected(Bundle bundle) {
        ...
        currentLatlong = new LatLng(mLocation.getLatitude(), mLocation.getLongitude());
        adddirection();
    }
