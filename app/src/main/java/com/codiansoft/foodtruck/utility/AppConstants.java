...
public class AppConstants {
    ...
    // server constants
    public static final String SERVER_URL = "http://api-staging.zaminapp.com/";
    public static final String USER_REGISTER = SERVER_URL + "auth/register";
    public static final String LOGIN = SERVER_URL + "auth";
    public static final String ADD_DEVICE = SERVER_URL + "devices";
    public static final String GET_DEVICE = SERVER_URL + "users/devices";
    ...
    //Login type : 1 for new user 2 for old user
